...
def _main():
   ...
   "H  9.213265  -1.651184  0.000000"
    ...
    geometry_name = perylene  # Change this based on the geometry used (e.g., geometry_C6H6, geometry_C14H10, etc.)
    # ----------------------------------------------------------------
    ...
    # ================================================================
    try:
        mol_name = "FCI_Perylene_tuned"  # Change this based on the geometry used (e.g., "H2O", "CO2", "Benzene", etc.)
