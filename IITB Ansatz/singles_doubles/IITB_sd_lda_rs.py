...
# IITB pART 1
    ...
    for ex in fer_excitation_op_s:
        final_dob_list.append(mapper.map(ex))
    ...
    # Combined total excitations (Pruned Doubles + All Singles)
...
# ---------- 🔹 VQE callback with quantum timing & convergence tracking ----------
    ...
    # ================================================================
    try:
        mol_name = "IITB_sd_Pyridine_lda_rs"  # Change this based on the geometry used (e.g., "H2O", "CO2", "Benzene", etc.)
