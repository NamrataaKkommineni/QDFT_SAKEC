# Quantum DFT Embedding Profiler (IITB Ansatz)
...
## 🚀 Overview
While standard Qiskit runtime scripts treat the optimization loop as a black box, `profileIITB.py` cracks it open. It provides millisecond-accurate, per-iteration breakdowns of where your compute time is actually going: circuit evaluation, gradient calculation, classical optimizer logic, or Qiskit overhead.

## 🧬 Simulation Specifics: The IITB Ansatz
**Note:** This specific script utilizes the **IITB** ansatz, initialized with a Hartree-Fock state. 

*(If you are looking for the version of this profiler that implements the custom **UCCSD ansatz**, please refer to the alternate script provided in this repository.)*
...
## 🧪 Alternative Functionals: `profile_otherfunc.py`
...
**Note** 
* This specific script utilizes the UCCSD IITB ansatz.
