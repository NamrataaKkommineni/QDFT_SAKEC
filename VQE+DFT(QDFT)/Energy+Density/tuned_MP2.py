...
def _main():
   ...
   "H  9.213265  -1.651184  0.000000"
    ...
    #beta = 0.46
    #Tuned
    mu = 0.25   # Range separation (ω)
    alpha = 0.19  # Short-range HF fraction
    beta = 0.11  # Long-range addition (Total LR = alpha + beta = 1.0)
...
# ---------- 🔹 VQE callback with quantum timing & convergence tracking ----------
    ...
    # ================================================================
    try:
        mol_name = "Perylene_tuned_MP2"  # Change this based on the geometry used (e.g., "H2O", "CO2", "Benzene", etc.)
